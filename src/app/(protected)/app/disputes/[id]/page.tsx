  ...
  return (
    <>
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2">
        <Card><h2 className="font-black">Performer position</h2><p className="mt-3 text-sm leading-6 text-muted-foreground">{dispute.performer_explanation}</p><h3 className="mt-5 text-sm font-black">Reviewer rejection</h3><p className="mt-2 text-sm leading-6 text-muted-foreground">{dispute.reviewer_rejection_reason}</p></Card>
        <Card className="border-cyan-300/25 bg-cyan-400/10">
          ...
          <p className="mt-4 text-xs font-bold text-muted-foreground">Recommendation only. No financial or pledge action is automatic.</p>
        </Card>
      </div>
